...
/**
 * \file    core/triggers/interface_99_modGestion_GestionTriggers.class.php
 * \ingroup gestion
 ...
 *      - interface_99_modGestion_MyTrigger.class.php
...
/**
 *  Class of triggers for Gestion module
 */
class InterfaceGestionTriggers extends DolibarrTriggers
{
	/**
	 * Constructor
	 *
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "Gestion triggers.";
		$this->version = self::VERSIONS['dev'];
		$this->picto = 'gestion@gestion';
	}
	...
	public function runTrigger($action, $object, User $user, Translate $langs, Conf $conf)
	{
		...
		switch ($action) {  // @phan-suppress-current-line PhanNoopSwitchCases
			...
			case 'LINEBILL_SUPPLIER_CREATE':
				$supplier = new SupplierInvoiceLine ($this->db);
				$supplier->fetch($object->id);
				if (!empty($_POST['units'])) {
					$supplier->fk_unit = $_POST['units'];
					var_dump($supplier->fk_unit);
					var_dump($supplier->update());
				}
				break;
